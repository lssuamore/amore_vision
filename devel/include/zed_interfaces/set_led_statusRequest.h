...
bool operator==(const ::zed_interfaces::set_led_statusRequest_<ContainerAllocator1> & lhs, const ::zed_interfaces::set_led_statusRequest_<ContainerAllocator2> & rhs)
{
  return lhs.led_enabled == rhs.led_enabled;
}

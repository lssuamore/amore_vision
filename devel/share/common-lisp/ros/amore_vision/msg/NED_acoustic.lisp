...
(cl:defmethod cl:initialize-instance :after ((m <NED_acoustic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NED_acoustic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name amore_vision-msg:<NED_acoustic> is deprecated: use amore_vision-msg:NED_acoustic instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <NED_acoustic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader amore_vision-msg:points-val is deprecated.  Use amore_vision-msg:points instead.")
  (points m))

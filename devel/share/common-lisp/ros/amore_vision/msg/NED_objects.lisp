...
(cl:defmethod cl:initialize-instance :after ((m <NED_objects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NED_objects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name amore_vision-msg:<NED_objects> is deprecated: use amore_vision-msg:NED_objects instead.")))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <NED_objects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader amore_vision-msg:objects-val is deprecated.  Use amore_vision-msg:objects instead.")
  (objects m))
